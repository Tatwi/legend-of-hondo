...
layouts = {
		...
		plots = {
			{ -- Plot 1
				...
				buildings = {
					...
					{price = 12000, buildingName = "Salon Tent: Brown (Decorated)", template = "object/building/tatooine/salon_tatooine.iff", zoning = 0},
					{price = 12000, buildingName = "Salon Tent: Grey (Decorated)", template = "object/building/corellia/salon_corellia.iff", zoning = 0},
					{price = 12000, buildingName = "Salon Tent: Green (Decorated)", template = "object/building/naboo/salon_naboo.iff", zoning = 0},
	...
	singleLargeLong = {
		terminal = {name = "Single Long City Lot", x = 0, y = 30.4, localRotation = 0},
		plots = {
			{ -- Plot 1
				...
				buildings = {
					...
					{price = 650000, buildingName = "Cantina: Naboo Player Style", template = "object/building/player/city/cantina_naboo.iff", zoning = 0},
					{price = 650000, buildingName = "Cantina: Tatooine Player Style", template = "object/building/player/city/cantina_tatooine.iff", zoning = 0},
					{price = 199000, buildingName = "Combat Guild Hall: Corellia", template = "object/building/corellia/guild_combat_corellia_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "Combat Guild Hall: Naboo", template = "object/building/naboo/guild_combat_naboo_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "Combat Guild Hall: Tatooine", template = "object/building/tatooine/guild_combat_tatooine_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "Commerce Guild Hall: Corellia", template = "object/building/corellia/guild_commerce_corellia_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "Commerce Guild Hall: Naboo", template = "object/building/naboo/guild_commerce_naboo_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "Commerce Guild Hall: Tatooine", template = "object/building/tatooine/guild_commerce_tatooine_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "University: Corellia", template = "object/building/corellia/guild_university_corellia_style_01.iff", zoning = 0},
					{price = 199000, buildingName = "University: Naboo", template = "object/building/naboo/guild_university_naboo_style_01.iff", zoning = 0},
	...
	singleHuge = {
		...
		plots = {
			{ -- Plot 1
				...
				buildings = {
					{price = 265000, buildingName = "Cantina - Tatooine NPC Style", template = "object/building/tatooine/cantina_tatooine.iff", zoning = 0, rotationFudge = 90},
					{price = 265000, buildingName = "Cantina - Corellia NPC Style", template = "object/building/corellia/cantina_corellia.iff", zoning = 0, rotationFudge = 90},
					{price = 265000, buildingName = "Cantina - Naboo NPC Style", template = "object/building/naboo/cantina_naboo.iff", zoning = 0, rotationFudge = 90},
					...
					{price = 265000, buildingName = "Theatre - Corellia NPC Style", template = "object/building/corellia/guild_theater_corellia_s01.iff", zoning = 0, rotationFudge = 180},
					{price = 265000, buildingName = "Theatre - Naboo NPC Style", template = "object/building/naboo/guild_theater_naboo_s01.iff", zoning = 0, rotationFudge = 180},
					{price = 265000, buildingName = "Theatre - Tatooine NPC Style", template = "object/building/tatooine/guild_theater_tatooine_style_01.iff", zoning = 0, rotationFudge = 180},
					{price = 265000, buildingName = "Hotel - Corellia Large NPC Style", template = "object/building/corellia/hotel_corellia.iff", zoning = 0},
					{price = 265000, buildingName = "Hotel - Naboo Large NPC Style", template = "object/building/naboo/hotel_naboo.iff", zoning = 0},
					{price = 265000, buildingName = "Hotel - Tatooine Large NPC Style", template = "object/building/tatooine/hotel_tatooine.iff", zoning = 0},
				},
			},
		},
	},
	...
	singleHugest = {
		...
		plots = {
			{ -- Plot 1
				plotName = "Single Huge Structure", x = 0, y = 0, localRotation = 0,
				buildings = {
					{price = 435000, buildingName = "Capitol: Tatooine", template = "object/building/tatooine/capitol_tatooine.iff", zoning = 0},
					{price = 435000, buildingName = "Capitol: Corellia", template = "object/building/corellia/capitol_corellia.iff", zoning = 0},
					{price = 435000, buildingName = "Capitol: Naboo", template = "object/building/naboo/capitol_naboo_theed.iff", zoning = 0},
					{price = 395000, buildingName = "Hospital - Corellia Large NPC Style", template = "object/building/corellia/hospital_corellia.iff", zoning = 0, rotationFudge = 90},
					{price = 395000, buildingName = "Hospital - Naboo Large NPC Style", template = "object/building/naboo/hospital_naboo.iff", zoning = 0, rotationFudge = 90},
					{price = 395000, buildingName = "Hospital - Tatooine Large NPC Style", template = "object/building/tatooine/hospital_tatooine.iff", zoning = 0, rotationFudge = 90},
				},
			},
		},
	},
		...
		plots = {
			...
			{ -- Plot 2
				...
				buildings = {
					...
					{price = 15000, buildingName = "Small Tatooine Style 2", template = "object/building/player/player_house_tatooine_small_style_02.iff", zoning = 0},
				},
			},
			{ -- Plot 3

...
includeFile("hondo/admin/placestructure_items.lua")
...
function AdminPlaceStructure:showCategories(pPlayer)
	...
	promptText = (promptText .. "TIP: Use /hondo admin showRuler to show a green line that will help you better visualize the alignment.\n\n")

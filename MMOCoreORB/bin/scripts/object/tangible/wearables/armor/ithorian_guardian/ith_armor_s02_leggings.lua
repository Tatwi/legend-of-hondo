...
object_tangible_wearables_armor_ithorian_guardian_ith_armor_s02_leggings = object_tangible_wearables_armor_ithorian_guardian_shared_ith_armor_s02_leggings:new {
	...
	vulnerability = ELECTRICITY + STUN + HEAT + COLD + ACID + LIGHTSABER,

	specialResists = BLAST,

	-- These are default Blue Frog stats
	healthEncumbrance = 65,
	actionEncumbrance = 275,
	mindEncumbrance = 65,
	...
	experimentalMin = {0, 0, 0, 1000, 1, 30000, 80, 300, 80, 1, 0, 0, 0},
	experimentalMax = {0, 0, 0, 1000, 40, 50000, 50, 150, 50, 1, 0, 0, 0},

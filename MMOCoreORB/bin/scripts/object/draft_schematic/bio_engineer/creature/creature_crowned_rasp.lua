...
object_draft_schematic_bio_engineer_creature_creature_crowned_rasp = object_draft_schematic_bio_engineer_creature_shared_creature_crowned_rasp:new {

   templateType = DRAFTSCHEMATIC,
   disableFactoryRun = true,	

   customObjectName = "Crowned Rasp",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/crowned_rasp_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_crowned_rasp, "object/draft_schematic/bio_engineer/creature/creature_crowned_rasp.iff")

...
-- Non-aggressive versions (that can use emotes)
includeFile("faction/imperial/no_agro_imperial_army_captain.lua")
includeFile("faction/imperial/no_agro_droid_corps_junior_technician.lua")
includeFile("faction/imperial/no_agro_imperial_cadet.lua")
includeFile("faction/imperial/no_agro_signalman.lua")
